const translations = {
    es: {
        ...
        method: {
            ...
            feat2_desc: "El método combina teoría con práctica, permitiendo a los estudiantes experimentar y descubrir por sí mismos.",
            feat3_title: "Certificación Validada",
            feat3_desc: "Al completar el programa, los estudiantes reciben una certificación que avala sus conocimientos y habilidades STEM."
        },
        bluebook: {
            eyebrow: "El Material",
            desc: "El libro central del programa JóvenesSTEM. Un material cuidadosamente desarrollado que presenta los conceptos STEM de manera accesible y atractiva para las nuevas generaciones.",
        ...
        explorer: {
            ...
            tab3: "Programación & Código",
            cap1_title: "La base del universo",
            cap1_desc: "Viajaremos desde el Big Bang hasta la estructura misma de la vida. Entender las reglas del juego (Física, Biología, Química) es vital para dominar el futuro.",
            ...
            cap2_desc: "Desmitificamos la \"caja negra\". Abriremos dispositivos para entender la ciencia de materiales, óptica y electrónica que los hace funcionar.",
            cap2_item1_title: "Pantallas y Óptica",
            cap2_item1_desc: "OLED vs LED, lentes, apertura y resolución.",
            cap2_item2_title: "Conectividad Inalámbrica",
            cap2_item2_desc: "Redes 5G, Wi-Fi y latencia en sistemas.",
            cap2_item3_title: "Procesamiento y Memoria",
            cap2_item3_desc: "CPUs Multicore, DDR y lógica binaria.",
            cap2_item4_title: "Nanotecnología",
            cap2_item4_desc: "El futuro a escala microscópica.",
            cap3_title: "El Lenguaje del Código",
            cap3_desc: "No basta con usar apps, hay que crearlas. Introducción sólida al pensamiento computacional, algoritmos y la lógica detrás de la IA.",
            cap3_item1_title: "Introducción a la Programación",
            cap3_item1_desc: "Sintaxis, variables y estructuras de control.",
            cap3_item2_title: "Inteligencia Artificial",
        ...
        cert: {
            ...
            title: "Certificación <span class=\"text-siip\">Oficial</span>",
        ...
        price: {
            ...
            fast_focus: "<strong>Enfoque:</strong> Teórico y demostrativo",
            curr_title: "Curricular (Normal)",
            curr_ideal: "<strong>Ideal para:</strong> Integración completa en plan de estudios.",
            curr_focus: "<strong>Enfoque:</strong> Teórico + Práctico (Laboratorio)",
            cta_impl: "Conoce las Opciones de Implementación",
            lic_fast: "Licencia FastTrack",
            lic_curr: "Licencia Curricular",
            per_student: "Por Alumno",
            note_mat: "+ costo material impreso ($60-70 MXN)",
            note_total_fast: "Costo total aprox: ~$90-100 MXN",
            note_total_curr: "Costo total aprox: ~$100-110 MXN",
            inc_title: "Incluye:",
            ft_item1: "BlueBook v1 (Versión FastTrack)",
            ft_item2: "Certificación Oficial",
            ft_item3: "Acceso a Laboratorio y Manual",
            ft_item4: "Asesoría del Autor",
            cr_item1: "Libro BlueBook v1 Completo (90h)",
            cr_item2: "Certificación Oficial Completa",
            cr_item3: "Acceso a Laboratorio y Manual Docente",
            cr_item4: "Asesoría del Autor",
    ...
    en: {
        ...
        cert: {
            ...
            title: "Official <span class=\"text-siip\">Certification</span>",
        ...
        price: {
            ...
            fast_focus: "<strong>Focus:</strong> Theoretical and demonstrative",
            curr_title: "Curricular (Normal)",
            curr_ideal: "<strong>Ideal for:</strong> Full integration into curriculum.",
            curr_focus: "<strong>Focus:</strong> Theoretical + Practical (Lab)",
            cta_impl: "See Implementation Options",
            lic_fast: "FastTrack License",
            lic_curr: "Curricular License",
            per_student: "Per Student",
            note_mat: "+ printed material cost ($60-70 MXN)",
            note_total_fast: "Total approx cost: ~$90-100 MXN",
            note_total_curr: "Total approx cost: ~$100-110 MXN",
            inc_title: "Includes:",
            ft_item1: "BlueBook v1 (FastTrack Version)",
            ft_item2: "Official Certification",
            ft_item3: "Access to Lab and Manual",
            ft_item4: "Author Advisory",
            cr_item1: "Full BlueBook v1 (90h)",
            cr_item2: "Full Official Certification",
            cr_item3: "Access to Lab and Teacher Manual",
            cr_item4: "Author Advisory",
